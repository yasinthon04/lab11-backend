...
public interface EventRepository extends JpaRepository<Event,Long> {
    ...
    Page<Event> findByTitleContainingOrDescriptionContaining_NameIgnoreCaseContaining(String title,String description,String organizerName,  Pageable pageable);
}
